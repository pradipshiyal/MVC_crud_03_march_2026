...
?>
	<div class="container d-flex justify-content-center align-items-center">
    	<div class="card shadow-lg p-4 add-brand">
        	...
        	<form action="<?= BASE_URL ?>brand/edit/<?= $data["B_ID"] ?? ''; ?>" method="POST" enctype="multipart/form-data">
				<div class="row mb-3">
					<div class="col">
                		<label class="form-label">Brand Name</label>
                		<input type="text" name="brand_name" value="<?= $data["B_NAME"] ?? ''; ?>" class="form-control" placeholder="Enter brand name" required>
					</div>
            	</div>
				<div class="row mb-3">
					<div class="col">
